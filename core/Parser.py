...
parser.add_argument('--file', help='A text file', default='./data/shakespeare', type=str)
...
parser.add_argument('--layers', help='List of layer info', default=[516,516], type=lambda s: [int(item) for item in s.split(',')])
