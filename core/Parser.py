...
parser.add_argument('--file', help='A text file or directory', default='./data/divina_commedia.txt', type=str)
...
parser.add_argument('--sequence_len', help='The sequence len', default=50, type=int)
parser.add_argument('--eta', help='The learning rate', default=0.01, type=float)
parser.add_argument('--layers', help='List of layer info', default=[512,512,512], type=lambda s: [int(item) for item in s.split(',')])
